...
$(eval $(call ADD2PACK,startscreen_z,src/assets/start.bin))
$(eval $(call PACKZX7B,startscreen_z,src/assets/))

$(eval $(call ADD2PACK,endingscreen_z,src/assets/gameover.bin))
$(eval $(call PACKZX7B,endingscreen_z,src/assets/))

$(eval $(call ADD2PACK,background_z,src/assets/background.bin))
$(eval $(call PACKZX7B,background_z,src/assets/))

$(eval $(call ADD2PACK,winscreen_z,src/assets/win.bin))
$(eval $(call PACKZX7B,winscreen_z,src/assets/))
